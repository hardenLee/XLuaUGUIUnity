...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public object __Gen_Delegate_Imp4(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(UnityEngine.GameObject p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Func<int, object>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(System.Action<UnityEngine.GameObject, int, object>))
			{
			    return new System.Action<UnityEngine.GameObject, int, object>(__Gen_Delegate_Imp5);
			}
